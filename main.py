...
Функции для выбора класса персонажа,для тренировки ,
для расчета урона и блокирования.
'''
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает спец.умение согласно классу персонажа."""
    if char_class == 'warrior':
